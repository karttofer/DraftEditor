...
export default class UndelineICon extends React.PureComponent {
  render() {
    return (
      <svg
        ...
        width="24px"
        height="24px"
        viewBox="0 0 970.5 970.5"
      >
        <g>
          <path d="M116.1,868.5c-28.2,0-51,22.8-51,51s22.8,51,51,51h741.5c28.199,0,51-22.8,51-51s-22.801-51-51-51H116.1z" />
          <path
            d="M940.9,45.1c0-4.9,0-10.1,0-15.1c0-16.6-13.4-30-30-30H582.199c-16.6,0-30,13.4-30,30v14.5c0,15.5,11.801,28.4,27.201,29.9
